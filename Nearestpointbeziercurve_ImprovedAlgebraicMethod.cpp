...
#if 0
			// ON_PolynomialCurveÇ©ÇÁÅA q(u)ÅAV(u)ÇªÇÍÇºÇÍÇÃåWêîóÒÇì«Ç›çûÇ›
...
//					v_coef[i][j] = q_coef[i][j] / w;
			...
			// x, y, zäeóvëfÇ…Ç¬Ç¢ÇƒÅA (w(u)V'(u) - w'(u)V(u)) x (w(u)p - V(u))ÇåvéZ
			...
			// è„ãLÇÃåWêîóÒÇÃx, y, zäeóvëfÇ…Ç¬Ç¢ÇƒëçòaÇéÊÇË(ì‡êœ)ÅA g(u)Ç∆Ç∑ÇÈÅB 
			...
			// x, y, zäeóvëfÇ…Ç¬Ç¢ÇƒÅA V'(u) x (p - V(u))ÇåvéZ
		...
		// g(u)ÇÃ Sturm Sequence ÇãÅÇﬂÇÈÅB 
...
//					else crange.second = tc;
			...
			// ç°Ç‹Ç≈ÇÃç≈íZãóó£ÇÊÇËÇ‡íZÇ¢èÍçáÇÕçXêV
